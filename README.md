...
## Описание инструментов используемых для выполнения финального задания
...
<br />
Решение реализовывалось на платформе Gitlab с пробным периодом до 29 декабря, без возможности открыть публичный доступ (только по приглашению), поэтому весь исходный код решения был мигрирован в этот публичный Github репозиторий. 
...
В решении использовалась следующая инфраструктура: 3 виртуальные машины (2 для приложения и одна для БД) и один L3-сетевой балансировщик для балансирования нагрузки на два инстанса приложения. <br />
